...
#
        ...
        # exit()
    def forward(self, pixel_values, aux_embeddings, rcnn_embeddings):
        batch_size = aux_embeddings.shape[0]
        class_embeds = self.class_embedding.expand(batch_size, 1, -1)
        embeddings = class_embeds

        # aux_embeds = []
        # for aux_embedding in aux_embeddings: [bsz,3,3,128,128] 3个3*128*128的图像
        ...
        embeddings = torch.randn((32,61,768))
        return embeddings
