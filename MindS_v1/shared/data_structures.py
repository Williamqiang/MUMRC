...
class Document:
    def __init__(self, js):
        ...
        self.img_id=js["img_id"]
        entries = fields_to_batches(js, ["doc_key", "clusters", "predicted_clusters", "section_starts","img_id"])
